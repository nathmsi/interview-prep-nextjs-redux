...
export function QuizAccordion({ items, hint }: QuizAccordionProps) {
  ...
  return (
    <div className="space-y-8">
      <p className="text-sm text-zinc-600 dark:text-zinc-400">
        {hint ??
          "Answer in the box under each question, then open the accordion only when you want to check the official solution."}
      </p>
      ...
      <p className="text-center text-sm text-zinc-500">
        {items.length} questions · basic → pro
      </p>
    </div>
  );
}
