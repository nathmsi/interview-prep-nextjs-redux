import type { NodeExercise } from "@/lib/nodejs-backend";
...
function exerciseHref(sectionSlug: string, exercise: NodeExercise) {
  return `/nodejs/${sectionSlug}/${exercise.slug}`;
}

export function NodeNav({ sectionSlug, prev, next }: NodeNavProps) {
